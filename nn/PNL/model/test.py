...
def main():
    ...
    print(f"Copy Rate:      {metrics['copy_rate']:.4f}")
    print(f"Bigram Overlap: {metrics['bigram_overlap']:.4f}")
    print(f"Avg P_Gen:      {metrics['avg_p_gen']:.4f}")
    print(f"Avg P_Copy:     {metrics['avg_p_copy']:.4f}")
